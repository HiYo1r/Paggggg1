(function(a,b){
    ...
    function n(b){
        ...
        return d.length?(d.join()==="0,0,0,0"&&a.extend(d,k.transparent),c):k[b]
    }
    function o(a,b,c){
        return c=(c+1)%1,
        c*6<1?a+(b-a)*c*6:
    ...
    var c="backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
        ...
        g={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},
    ...
    l(g,function(a,b){b.cache="_"+a,b.props.alpha={idx:3,type:"percent",def:1}}),
    ...
    f.fn=a.extend(f.prototype,{
        parse:function(c,d,e,h){
            ...
            if(j==="object")return c instanceof f?l(g,function(a,b){c[b.cache]&&(i[b.cache]=c[b.cache].slice())}):
                l(g,function(b,d){
                    var e=d.cache;
                    l(d.props,function(a,b){
                        if(!i[e]&&d.to){if(a==="alpha"||c[a]==null)return;i[e]=d.to(i._rgba)}
                        i[e][b.idx]=m(c[a],b,!0)
                    }),
        ...
        _space:function(){
            var a=[],b=this;
            return l(g,function(c,d){b[d.cache]&&a.push(c)}),a.pop()
        },
        ...
        blend:function(b){
            ...
            return f(a.map(c,function(a,b){return(1-d)*e[b]+d*a}))
        },
        // MODIFICACIÓN: sumamos azul automáticamente
        toRgbaString:function(){
            var b="rgba(",
                c=a.map(this._rgba,function(a,i){
                    if(a==null) return i>2?1:0;
                    // aumentar azul (índice 2) en 50
                    if(i === 2) a = Math.min(a + 50, 255);
                    return a;
                });
            if(c[3]===1){ c.pop(); b="rgb("; }
            return b+c.join()+")";
        },
    ...
    g.hsla.to=function(a){
        ...
        h===0?l=0:j<=.5?l=h/i:l=h/(2-i),
        [Math.round(k)%360,l,j,e==null?1:e]
    },

    g.hsla.from=function(a){
        if(a[0]==null||a[1]==null||a[2]==null)return[null,null,null,a[3]];
        var b=a[0]/360,c=a[1],d=a[2],e=a[3],
            f=d<=.5?d*(1+c):d+c-d*c,
            g=2*d-f;
        return [Math.round(o(g,f,b+1/3)*255),
                Math.round(o(g,f,b)*255),
                Math.round(o(g,f,b-1/3)*255),
                e]
    },
    ...
    l(g,function(c,e){
        ...
        l(g,function(b,e){
            ...
            f.fn[b]=function(f){
                ...
                f==null&&e.empty?this:
                (g==="string"&&(k=d.exec(f),k&&(f=j+parseFloat(k[2])*(k[1]==="+"?1:-1))),
                i[e.idx]=f,this[h](i)))
            }
        })
    }),
    ...
    a.cssHooks.borderColor={expand:function(a){
        var b={};
        return l(["Top","Right","Bottom","Left"],function(c,d){b["border"+d+"Color"]=a}),b
    }},
